    ...
    _createClass(Button, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'button',
                { type: 'button', onClick: this.handleClick, className: this.props.type ? this.props.type : 'default' },
                this.props.children
            );
        }
    }]);
...
var ajaxQuery = exports.ajaxQuery = function ajaxQuery(url, params, sucCB, unCB, errCB) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				{ ref: function ref(div) {
						_this2.div = div;
					}, className: 'box ' + (this.props.showConfirm ? 'show' : '') },
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(14),B=__webpack_require__(7),C=__webpack_require__(5),ba=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ia=__webpack_require__(19),D=__webpack_require__(8);
...
var _bg = __webpack_require__(47);

var _reservation = __webpack_require__(50);

var _Calculator = __webpack_require__(51);
...
var _registe = __webpack_require__(64);

var _learn = __webpack_require__(86);

var _util = __webpack_require__(11);

var _confirm = __webpack_require__(21);

var _editor = __webpack_require__(87);
...
var Type = document.querySelector('#type').value.firstUpperCase();
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentWillMount() {
            ...
            (0, _util.ajaxQuery)('/users/gs', {}, function (res) {
                ...
                if (res.data.result === 'TRUE') {
                    ...
                    _this2.state.socket.emit('online', userObj);
                    _this2.onHandleMenuLi('editor');
                }
            });
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'section',
                    { className: 'section' },
                    Type === 'Registe' ? _react2.default.createElement(_registe.Registe, { socket: this.state.socket, onHandleMenuLi: this.onHandleMenuLi }) : '',
                    this.state.showAction ? _react2.default.createElement(_index.Action, null) : '',
                    ...
                    this.state.showEditor ? _react2.default.createElement(_editor.Editor, { g35user: this.state.g35user }) : '',
...
var _leftBar = __webpack_require__(42);

var _basket = __webpack_require__(46);
...
var Action = function (_React$Component) {
    ...
    _createClass(Action, [{
        key: 'updateChange',
        value: function updateChange(item) {
            this.setState({
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_leftBar.LeftBar, { contents: this.state.contents, onChange: function onChange(item) {
                        _this2.updateChange(item);
                    } }),
                _react2.default.createElement(_basket.Basket, { type: this.state.type, onChange: function onChange(_item) {
                        _this2.backFun(_item);
                    } })
            );
        }
    }]);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.contents.map(function (item, index) {
                    return _react2.default.createElement(
                        "li",
                        { key: index, className: "indexLi" },
                        _react2.default.createElement(
                            "p",
                            null,
                            item
                        ),
                        _react2.default.createElement("i", { className: "indexBtn add", onClick: function onClick() {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./button.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./button.less");
...
var Basket = function (_React$Component) {
    ...
    _createClass(Basket, [{
        key: "deleteProduct",
        value: function deleteProduct(_item, index) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "ul",
                { className: "basket" },
                this.props.type.map(function (_item, index) {
                    return _react2.default.createElement(
                        "li",
                        { key: index, className: "indexLi" },
                        _react2.default.createElement(
                        ...
                        _react2.default.createElement("i", { className: "indexBtn deleted", onClick: function onClick() {
                                _this2.deleteProduct(_item, index);
                            } })
                    );
                })
            );
...
var BackGround = function (_React$Component) {
    ...
    function BackGround(props) {
        ...
        _this.date = new Date('2017-12-12').getTime() + 24 * 60 * 60 * 1000;
        return _this;
    }
    ...
    _createClass(BackGround, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('li', { style: { backgroundImage: this.state.imgUrl } })
            );
        }
    }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./background.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./background.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    'Is Going:',
                    _react2.default.createElement('input', { name: 'isGoing', type: 'checkbox', onChange: this.handleInputChange, checked: this.state.isGoing })
                ),
                _react2.default.createElement(
                    'label',
                    null,
                    'Number Of guests:',
                    _react2.default.createElement('input', { name: 'numberOfGuests', type: 'number', onChange: this.handleInputChange, value: this.state.numberOfGuests })
                ),
                _react2.default.createElement(
                    'button',
...
var _BoilingVerdict = __webpack_require__(52);

var _TemperatureInput = __webpack_require__(53);
...
var Calculator = function (_React$Component) {
    ...
    function Calculator(props) {
        ...
        _this.handleCelsius = _this.handleCelsius.bind(_this);
        _this.handleFahrenheit = _this.handleFahrenheit.bind(_this);
    ...
    _createClass(Calculator, [{
        key: "handleCelsius",
        value: function handleCelsius(temperature) {
            this.setState({ scale: 'c', temperature: temperature });
        }
    }, {
        key: "handleFahrenheit",
        value: function handleFahrenheit(temperature) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement(_TemperatureInput.TemperatureInput, { scale: scale, temperature: celsius, onTemperatureChange: this.handleCelsius }),
                _react2.default.createElement(_TemperatureInput.TemperatureInput, { scale: scale, temperature: fahrenheit, onTemperatureChange: this.handleFahrenheit }),
                _react2.default.createElement(_BoilingVerdict.BoilingVerdict, { celsius: parseFloat(celsius) })
            );
        }
    }]);
...
var _setting = __webpack_require__(57);
        ...
        items.push(_react2.default.createElement(
            ...
            function (index) {
                return _react2.default.createElement('div', { key: index, ref: function ref(div) {
                        props.divs.length <= props.xNum * props.yNum - 1 && props.divs.push(div);
...
var Game = function (_React$Component) {
    ...
    function Game(props) {
        ...
        _this2.handleItem = _this2.handleItem.bind(_this2);
        _this2.onSetting = _this2.onSetting.bind(_this2);
    ...
    _createClass(Game, [{
        ...
        value: function init() {
            ...
            var len1 = Math.min.apply(null, [this.state.xNum, this.state.yNum]);
            function random(_this) {
                var outerArr = [];
                while (outerArr.length < len1) {
                    var x = Math.floor(Math.random() * _this.state.xNum),
                        y = Math.floor(Math.random() * _this.state.yNum);
                    var arr = outerArr.findArr([x, y]);
        ...
        key: 'onSetting',
        value: function onSetting(xNum, yNum) {
            this.setState({
                xNum: xNum,
                yNum: yNum
            });
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_setting.Setting, { onSetting: this.onSetting }),
                _react2.default.createElement(Row, { xNum: this.state.xNum, divs: this.state.divs, yNum: this.state.yNum, onClickItem: this.handleItem }),
                _react2.default.createElement(
                    _index.Button,
                ...
                _react2.default.createElement(
                    _confirm.Confirm,
                    { showConfirm: this.state.showConfirm, onCancel: this.handleCancel, onOk: this.handleOk },
                    _react2.default.createElement(
                        'p',
                        null,
                        this.state.content
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./game.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./game.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
  ...
  _createClass(Setting, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'label',
          { htmlFor: 'xNum', className: 'game-setting-label' },
          _react2.default.createElement('input', { className: 'game-setting-input', type: 'number', onChange: function onChange(e) {
              _this2.handleX(e);
            }, value: this.state.xNum })
        ),
        _react2.default.createElement(
          'label',
          { htmlFor: 'yNum', className: 'game-setting-label' },
          _react2.default.createElement('input', { className: 'game-setting-input', type: 'number', onKeyDown: function onKeyDown(e) {
              e.keyCode === 13 && _this2.handleClick();
...
var Header = function (_React$Component) {
	...
	function Header(props) {
		...
		_this.state = {
			rightBar: [{ value: '————', type: 'line' }, { value: 'game', type: 'other' }, { value: 'action', type: 'other' }, { value: 'reservation', type: 'other' }, { value: 'calculator', type: 'other' }, { value: 'chat', type: 'other' }, { value: 'learn', type: 'other' }, { value: 'editor', type: 'other' }]
		};
		return _this;
	}
	...
	_createClass(Header, [{
		...
		value: function handleMenu() {
			...
			if (this.nav.classList.contains('active') || this.menu.classList.contains('active') || MenuOverlay.classList.contains('active')) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ href: 'javascript:void(0);', ref: function ref(a) {
								_this2.menu = a;
							}, onClick: this.handleMenu, className: 'menu' },
						_react2.default.createElement(
							'span',
							null,
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./head.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./head.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var Chat = function (_React$Component) {
	...
	function Chat(props) {
		...
		_this2.checkTitle = _this2.checkTitle.bind(_this2);
		_this2.state = {
			users: [],
			contents: []
		};
	...
	_createClass(Chat, [{
		...
		value: function init() {
			...
			this.props.socket.on('system', function (user, roomInfo) {
		...
		value: function handleEnter(e) {
			...
			if (e.keyCode === 13) {
				...
				this.props.socket.send({ content: content, from: this.props.g35user.user_id, target: 'all', avatar: this.props.g35user.avatar });
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'message-box ' + this.props.animation },
				_react2.default.createElement(
					'div',
					{ className: 'message-users' },
					_react2.default.createElement(
						'ul',
						null,
						this.state.users.map(function (_item, index) {
							return _item.excited_room ? _react2.default.createElement(
								'li',
								{ key: index },
								...
								'li',
								{ key: index },
								_react2.default.createElement('img', { src: _item.avatar, className: 'avatar' }),
								_react2.default.createElement(
									'p',
									null,
									_item.nickname
				...
				_react2.default.createElement(
					...
					!!this.checkTitle() ? _react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'span',
							{ className: 'check-member' },
							'\u67E5\u770B\u6210\u5458'
						)
					) : '',
					_react2.default.createElement(
						'div',
						{ className: 'message-over' },
						_react2.default.createElement(
							'ul',
							{ ref: function ref(ul) {
									_this4.ul = ul;
								} },
							this.state.contents.map(function (_item, index) {
								return _react2.default.createElement(
									'li',
									{ key: index, ref: function ref(li) {
											_this4.li = li;
										} },
									_react2.default.createElement('img', { src: _item.avatar, className: 'avatar ' + (_item.from === _this4.props.g35user.user_id ? 'self' : '') }),
									_react2.default.createElement(
										'p',
										{ className: 'content ' + (_item.from === _this4.props.g35user.user_id ? 'self' : '') },
										_item.content
									)
								);
							})
				...
				_react2.default.createElement('div', { className: 'message-input', onChange: function onChange(e) {
						return _this4.editChange(e);
					}, contentEditable: 'true', onKeyDown: function onKeyDown(e) {
						_this4.handleEnter(e);
					} })
			);
		}
	}]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./chat.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./chat.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".message-box {\n  width: 740px;\n  height: 550px;\n  border-radius: 5px;\n  position: absolute;\n  visibility: hidden;\n  top: calc(50% + 40px);\n  left: 50%;\n  transition: all .3s ease;\n  opacity: 0;\n  background-color: #fff;\n}\n.message-box .message-users {\n  width: 250px;\n  position: absolute;\n  left: 0;\n  top: 0;\n  height: 100%;\n  box-sizing: border-box;\n  z-index: 1;\n  background-color: #CE93D8;\n  border-radius: 5px 0 0 5px;\n}\n.message-box .message-users li {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  padding: 6px 15px;\n  line-height: 30px;\n  box-sizing: border-box;\n}\n.message-box .message-users li img.avatar {\n  width: 30px;\n  height: 30px;\n  border-radius: 30px;\n  margin-right: 12px;\n}\n.message-box .message-users li p {\n  -webkit-box-flex: 1;\n      -ms-flex: 1;\n          flex: 1;\n}\n.message-box .message-users li.active {\n  background-color: rgba(0, 175, 240, 0.31);\n}\n.message-box .message-title {\n  height: 50px;\n  line-height: 38px;\n  background: #55acee;\n  padding: 6px 15px;\n  overflow: hidden;\n}\n.message-box .message-title .check-member {\n  float: right;\n  cursor: pointer;\n  color: #f9f9f9;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n.message-box .message-over {\n  padding: 15px 15px 0;\n  height: calc(100% - 50px);\n  overflow-x: hidden;\n  overflow-y: auto;\n}\n.message-box .message-contents {\n  margin-left: 250px;\n  height: calc(100% - 180px);\n  background: #68768A;\n  border-radius: 0 5px 0 0;\n  overflow: hidden;\n}\n.message-box .message-contents ul {\n  list-style: none;\n}\n.message-box .message-contents li {\n  overflow: hidden;\n  padding-bottom: 8px;\n}\n.message-box .message-contents p.content {\n  background: #fff;\n  display: inline-block;\n  max-width: 240px;\n  border-radius: 4px;\n  line-height: 32px;\n  padding: 0 6px;\n  position: relative;\n  float: left;\n}\n.message-box .message-contents p.content.self {\n  background: #4FC3F7;\n  float: right;\n}\n.message-box .message-contents img.avatar {\n  width: 30px;\n  height: 30px;\n  border-radius: 30px;\n  float: left;\n  margin-right: 8px;\n}\n.message-box .message-contents img.avatar.self {\n  float: right;\n  margin-left: 8px;\n}\n.message-box .message-input {\n  margin-left: 250px;\n  height: 180px;\n  border-top: 1px solid #ebebeb;\n  box-sizing: border-box;\n  padding: 6px 15px;\n}\n.message-box .message-input:focus {\n  outline: none;\n}\n.message-box.active {\n  opacity: 1;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n  visibility: visible;\n}\n", ""]);
...
var Registe = function (_React$Component) {
	_inherits(Registe, _React$Component);

	function Registe(props) {
		_classCallCheck(this, Registe);

		var _this = _possibleConstructorReturn(this, (Registe.__proto__ || Object.getPrototypeOf(Registe)).call(this, props));
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('input', { className: '_input', type: 'text', value: this.state.nickname, placeholder: '\u8F93\u5165\u6635\u79F0' })
				),
				_react2.default.createElement(
					'label',
					{ onChange: function onChange(e) {
					...
					_react2.default.createElement('input', { className: '_input', type: 'password', value: this.state.password, placeholder: '\u8F93\u5165\u5BC6\u7801' })
				),
				...
				_react2.default.createElement(
					'label',
					null,
					_react2.default.createElement('div', { className: '_input' }),
					_react2.default.createElement('input', { type: 'file', onChange: function onChange(e) {
							return _this3.uploadFile(e);
						}, className: 'files', capture: 'camera', accept: 'image/png, image/jpg, image/jpeg' })
				),
				_react2.default.createElement(
					_index.Button,
					{ onClick: function onClick(e) {
							return _this3.registe();
						} },
					'\u6CE8\u518C'
				)
			);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./registe.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./registe.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var Learn = function (_React$Component) {
  ...
  */
	...
	_createClass(Learn, [{
		key: 'compareArr',
		value: function compareArr(arr1, arr2) {
			var result = [],
			    arr;
			console.log(1231);
    ...
    */
		...
		key: 'render',
		value: function render() {
			var result = JSON.stringify(this.compareArr(['b', 'c'], [{ key: 'a' }]));
			return _react2.default.createElement(
				'div',
				{ style: { color: '#f9f9f9' } },
				_react2.default.createElement(
...
var Editor = function (_React$Component) {
	...
	_createClass(Editor, [{
		...
		key: 'handleItem',
		value: function handleItem(e, key) {
			var _this3 = this;
   ...
   */
		...
		key: 'createElement',
		value: function createElement(targeName) {
		...
		key: 'adjustList',
		value: function adjustList() {
			var lists = this.state.editor.querySelectorAll("ol, ul");
   ...
   */
		...
		key: 'resetRange',
		value: function resetRange(startContainer, startOffset, endContainer, endOffset) {
			var selection = window.getSelection();
			selection.removeAllRanges();
			var range = document.createRange();
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'ul',
					{ className: 'nav' },
					this.state.navs.map(function (_nav, index) {
						return _react2.default.createElement(
							'li',
							{ key: index },
				...
				_react2.default.createElement('div', { id: 'rich-editor', contentEditable: 'true' })
			);
		}
	}]);
